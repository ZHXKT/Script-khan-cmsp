  ...
  CMSPHacks â€” VersÃ£o VISUAL SOMENTE
  Esta versÃ£o contÃ©m apenas a interface, animaÃ§Ãµes e elementos visuais.
  Todas as funcionalidades que interagem com sites externos ou automatizam respostas
  foram removidas por razÃµes de seguranÃ§a e conformidade. VocÃª pode usar este
  script como base visual e inserir suas funÃ§Ãµes localmente se entender as
  implicaÃ§Ãµes legais e Ã©ticas.
*/
...
(function() {
    ...
    function showToast(message, type = "info", duration = 3000) {
        ...
        toast.innerHTML = `
            <div class="cmsphacks-toast-icon">${type === "success" ? "âœ“" : type === "error" ? "âœ—" : "â€¢"}</div>
    ...
    JSON.parse = function(text, reviver) {
        ...
        if (features.revealAnswers && data && data.data) {
            try {
                ...
                showToast("Funcionalidade ativada", "success", 2000);
            } catch (e) {}
        }
        return data;
    };

    // Intercepta requisiÃ§Ãµes para modificar questÃµes
        ...
        if (features.questionSpoof && originalResponse.ok) {
            ...
            try {
                ...
                if (responseObj && responseObj.data && responseObj.data.assessmentItem && responseObj.data.assessmentItem.item && responseObj.data.assessmentItem.item.itemData) {
                    const phrases = [
                        "ðŸš€ Feito por [@bakai](https://github.com/KilluaWq)",
                        "ðŸ’« CrÃ©ditos para [@bakai](https://github.com/KilluaWq)",
                        "ðŸ”­ Acesse o GitHub do [@bakai](https://github.com/KilluaWq)",
                        "ðŸŒŒ Entre no nosso Discord: [cmsphacks](https://discord.gg/QAm62DDJ)",
                        "ðŸŒ  cmsphacks sempre em frente"
                    ];
                    ...
                    itemData.question.widgets = { 
                        "radio 1": { 
                            ...
                            options: { 
                                choices: [
                                    { content: "âœ… Correto", correct: true }, 
                                    { content: "âŒ Errado (nao clique aqui animal)", correct: false }
                                ] 
                            } 
                        } 
                    };
                    responseObj.data.assessmentItem.item.itemData = JSON.stringify(itemData);
                    showToast("ConfiguraÃ§Ã£o aplicada", "success", 2000);
    ...
    function gameLoop() {
        ...
        if (now - lastFrameTime >= 1000) {
            ...
            if (fpsCounter) fpsCounter.textContent = `âœ¨ ${frameCount}`;
            frameCount = 0;
            lastFrameTime = now;
        }
    ...
    (async function initializeUI() {
        ...
        splash.innerHTML = `
            <div class="cmsphacks-splash-content">
                ...
                <div class="cmsphacks-splash-subtitle">Carregando sistema de automaÃ§Ã£o</div>
        ...
        // Espera um pouco para mostrar que estÃ¡ carregando
        await delay(1800);
        
        // Faz o splash screen desaparecer suavemente
        splash.classList.add("fadeout");
        
        // Espera a animaÃ§Ã£o de fadeout terminar
        await delay(500);

        // CRIA O BOTÃƒO DE MENU
        ...
        panel.innerHTML = `
            <div class="cmsphacks-header">
                <div class="cmsphacks-title">
                    <span class="cmsphacks-title-icon">ðŸŒ™</span>
                    cmsphacks Lunar
                </div>
            ...
            <div id="cmsphacks-tab-visual" class="cmsphacks-tab-content">
                <button id="cmsphacks-btn-dark" class="cmsphacks-button active">
                    <span class="cmsphacks-icon">ðŸŒ“</span>
                    <span>Modo Escuro</span>
                </button>
                <button id="cmsphacks-btn-rgb" class="cmsphacks-button">
                    <span class="cmsphacks-icon">ðŸŽ¨</span>
                    <span>Logo RGB DinÃ¢mico</span>
                </button>
            </div>
            <div id="cmsphacks-tab-about" class="cmsphacks-tab-content">
                <div class="cmsphacks-about-content">
                    <p>Um sistema avanÃ§ado de automaÃ§Ã£o e personalizaÃ§Ã£o para Khan Academy, projetado para melhorar sua experiÃªncia de aprendizado com recursos inteligentes e interface intuitiva.</p>
                    
                    <div class="cmsphacks-features">
                        <div class="cmsphacks-feature">
                            <div class="cmsphacks-feature-title">AutomaÃ§Ã£o Inteligente</div>
                            <div>Respostas automÃ¡ticas com controle de velocidade ajustÃ¡vel</div>
                        </div>
                        <div class="cmsphacks-feature">
                            <div class="cmsphacks-feature-title">SeguranÃ§a AcadÃªmica</div>
                            <div>RevelaÃ§Ã£o discreta de respostas e modificaÃ§Ã£o de conteÃºdo</div>
                        </div>
                        <div class="cmsphacks-feature">
                            <div class="cmsphacks-feature-title">PersonalizaÃ§Ã£o Completa</div>
                    ...
                    <div class="cmsphacks-social-links">
                        <a href="https://discord.gg/QAm62DDJ" target="_blank" class="cmsphacks-social-btn">
                            <span class="cmsphacks-social-icon">ðŸ’¬</span>
                            <span>Discord</span>
                        </a>
                    ...
                    <div class="cmsphacks-credits">
                        Desenvolvido com â¤ por <a href="https://github.com/KilluaWq" target="_blank">@bakai</a><br>
                        cmsphacks Lunar â€¢ Sempre Ã  frente da curva
                    </div>
                </div>
            </div>
        ...
        function toggleRgbLogo(isActive) {
            ...
            if (!khanLogo) {
                showToast("Logo do Khan Academy nÃ£o encontrada", "error");
                return;
            }
        ...
        function startDragging(e) {
            // Ignora se clicou em um botÃ£o ou input
            if (e.target.closest('button, input, a, .cmsphacks-tab, .cmsphacks-range')) return;
            
            isDragging = true;
            const rect = panel.getBoundingClientRect();
            
            // Calcula o offset do mouse em relaÃ§Ã£o ao painel
            panelOffset = {
            ...
            // Marca o tempo do inÃ­cio do drag
        ...
        function drag(e) {
            ...
            // Limita a posiÃ§Ã£o para nÃ£o sair da tela
        ...
        function stopDragging() {
            ...
            if (dragDuration < 300) { // Se foi um movimento rÃ¡pido
